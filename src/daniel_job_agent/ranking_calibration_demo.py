...
def calibration_cases() -> list[JobOpportunity]:
    ...
    cases = (
        ...
        ("Procurement Expert", "Procurement Expert", "LATAM", None),
        ("Adobe InDesign Expert", "Adobe InDesign Expert", "Worldwide", None),
        ("InDesign Developer", "InDesign Automation Developer", "Worldwide", None),
        ("Trust & Safety Director", "Director of Trust & Safety", "Remote", None),
        ("Head of Risk", "Head of Risk", "Remote", None),
        ("Ambiguous Growth Consultant", "Revenue Growth Consultant", "LATAM", None),
        ("Revenue Operations", "Revenue Operations Analyst", "LATAM", None),
